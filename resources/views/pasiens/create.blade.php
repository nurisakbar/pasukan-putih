                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-6 col-md-4 col-lg-2 mb-2">
                                        <input type="text" class="form-control @error('rt') is-invalid @enderror"
                                            id="rt" name="rt" value="{{ old('rt') }}" placeholder="RT"
                                            required>
                                    </div>

                                    <div class="col-6 col-md-4 col-lg-2 mb-2">
                                        <input type="text" class="form-control @error('rw') is-invalid @enderror"
                                            id="rw" name="rw" value="{{ old('rw') }}" placeholder="RW"
                                            required>
                                        @error('rw')
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.message === "Pasien ditemukan") {
                                ...
                                setTimeout(function() {
                                    $('#regency').val(response.data.regency_id).trigger(
                                        'change');

                                    setTimeout(function() {
                                        $('#district').val(response.data
                                            .district_id).trigger('change');

                                        setTimeout(function() {
                                            $('#village').val(response
                                                .data.village_id);
                                        }, 300);
                                    }, 300);
                                }, 300);
