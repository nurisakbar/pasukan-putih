            ...
            <div class="row">
                <div class="col-md-6 mb-4">
                    <div class="card shadow-sm h-100">
                        ...
                        <div class="card-body">
                            <form action="{{ route('kunjungan.updateKunjunganFromPasiens', $kunjungan->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="form-group mb-3">
                                    <label for="nik" class="form-label">NIK</label>
                                    <input type="text" class="form-control nik bg-body-secondary" id="nik" name="nik"
                                        placeholder="NIK" value="{{ isset($kunjungan) ? $kunjungan->pasien->nik : old('nik') }}" readonly>
                                    @error('nik')
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control name bg-body-secondary" id="name" name="name"
                                        placeholder="Nama" value="{{ isset($kunjungan) ? $kunjungan->pasien->name : old('name') }}" readonly>
                                    @error('name')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control alamat bg-body-secondary" id="alamat" name="alamat"
                                        placeholder="Alamat" value="{{ isset($kunjungan) ? $kunjungan->pasien->alamat : old('alamat') }}" readonly >
                                    @error('alamat')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control"  name="skor_aks_data_sasaran"
                                        placeholder="1-20" value="{{ isset($kunjungan) ? $kunjungan->skor_aks_data_sasaran : old('skor_aks_data_sasaran') }}" required>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="date" id="inputDay" class="form-control" name="tanggal"
                                        placeholder="Tanggal" value="{{ isset($kunjungan) ? $kunjungan->tanggal : old('tanggal', date('Y-m-d')) }}">
                                </div>

                                <div class="form-group mb-3">
                                    <label for="status" class="form-label">Status</label>
                                    <select name="status" id="status" class="form-select">
                                        <option value="belum" {{ isset($kunjungan) && $kunjungan->status == 'belum' ? 'selected' : '' }}>Belum
                                        </option>
                                        <option value="sudah" {{ isset($kunjungan) && $kunjungan->status == 'sudah' ? 'selected' : '' }}>Sudah
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <select name="jenis" id="jenis" class="form-select">
                                        <option value="awal" {{ isset($kunjungan) && $kunjungan->jenis == 'awal' ? 'selected' : '' }}>Awal</option>
                                        <option value="rencana" {{ isset($kunjungan) && $kunjungan->jenis == 'rencana' ? 'selected' : '' }}>Rencana</option>
                                        <option value="lanjutan" {{ isset($kunjungan) && $kunjungan->jenis == 'lanjutan' ? 'selected' : '' }}>Lanjutan</option>
                                    </select>
                                </div>
                                ...
                                <div class="d-grid gap-2 d-md-flex">
                                    ...
                                    <a href="{{ route('pasiens.show', $kunjungan->pasien_id) }}" class="btn btn-outline-secondary px-4">Kembali</a>
                                </div>
                            </form>
                        </div>
                    </div>
