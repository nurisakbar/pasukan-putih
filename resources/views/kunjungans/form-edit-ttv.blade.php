    ...
    <div class="container-fluid mt-5">
        <div class="card border-0 shadow">
            <div class="card-header bg-primary text-white">
                <h4 class="mb-0">Edit Pemeriksaan Kesehatan</h4>
            </div>
               ...
               <div class="card-body">
                   <div class="row mb-4">
                       ...
                       <div class="col-md-6 col-lg-3 mb-3">
                           ...
                           <div class="input-group">
                               <input type="text" class="form-control" id="tension" name="blood_pressure" value="{{ old('blood_pressure', $ttv->blood_pressure) }}">
                       ...
                       <div class="col-md-6 col-lg-3 mb-3">
                           ...
                           <div class="input-group">
                               <input type="number" class="form-control" id="pulse" name="pulse" value="{{ old('pulse', $ttv->pulse) }}">
                       ...
                       <div class="col-md-6 col-lg-3 mb-3">
                           ...
                           <div class="input-group">
                               <input type="number" class="form-control" id="respiration" name="respiration" value="{{ old('respiration', $ttv->respiration) }}">
                       ...
                       <div class="col-md-6 col-lg-3 mb-3">
                           ...
                           <div class="input-group">
                               <input type="number" step="0.1" class="form-control" id="temperature" name="temperature" value="{{ old('temperature', $ttv->temperature) }}">
                   ...
                   <div class="row mb-4">
                       ...
                       <div class="col-md-6 col-lg-4 mb-3">
                           ...
                           <div class="input-group">
                               <input type="number" step="0.1" class="form-control" id="weight" name="weight" value="{{ old('weight', $ttv->weight) }}">
                       ...
                       <div class="col-md-6 col-lg-4 mb-3">
                           ...
                           <div class="input-group">
                               <input type="number" step="0.1" class="form-control" id="height" name="height" value="{{ old('height', $ttv->height) }}">
                           ...
                           <div class="card bg-light">
                               <div class="card-body">
                                   ...
                                   <div class="row g-2">
                                       <div class="col-md-4">
                                           <div class="input-group">
                                               <input type="number" step="0.01" class="form-control" id="bmi-result" name="bmi" value="{{ old('bmi', $ttv->bmi) }}" readonly>
