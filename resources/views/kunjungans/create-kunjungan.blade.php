                            ...
                            <form action="{{ route('kunjungans.store') }}" method="POST">
                               ...
                               <div class="form-group mb-3">
                                   ...
                                   <select name="status" id="status" class="form-select">
                                       <option value="Belum" {{ old('status') == 'Kunjungan Awal' ? 'selected' : '' }}>Kunjungan Awal</option>
                                       <option value="Sudah" {{ old('status') == 'Kunjungan Lanjutan' ? 'selected' : '' }}>Kunjungan Lanjutan</option>
                                   </select>
                               </div>
