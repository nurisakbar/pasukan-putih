...
<body>
    <div class="container">
        ...
        <h2>Login</h2>
        <form action="{{ route('login.lbe') }}" method="POST" id="loginForm">
            @csrf
            <div class="textbox">
                <input id="email" type="email" name="email" placeholder="Email" id="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
            </div>
